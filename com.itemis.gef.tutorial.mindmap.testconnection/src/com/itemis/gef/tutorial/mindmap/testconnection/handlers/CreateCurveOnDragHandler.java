 ...
 *
 *******************************************************************************/
package com.itemis.gef.tutorial.mindmap.testconnection.handlers;
...
import com.itemis.gef.tutorial.mindmap.testconnection.TestApplication;
import com.itemis.gef.tutorial.mindmap.testconnection.model.GeometricCurve;
...
public class CreateCurveOnDragHandler extends AbstractHandler implements IOnDragHandler {
	...
	public void startDrag(MouseEvent event) {
		...
		GeometricCurve curve = new GeometricCurve(new Point[] { new Point(), new Point() },
				TestApplication.GEF_COLOR_GREEN, TestApplication.GEF_STROKE_WIDTH, TestApplication.GEF_DASH_PATTERN, null);
